...
class BookListActivity : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            R.id.action_logout -> {
                // Logic Logout: Hapus session (jika ada) dan kembali ke Login
                val intent = Intent(this, LoginActivity::class.java)
                // Bendera ini membersihkan tumpukan activity agar user tidak bisa tekan Back
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bookAdapter = BookAdapter(mutableListOf(), userRole)
    ...
    private suspend fun insertInitialData() {
        val initialBooks = mutableListOf(
            Book(
                ...
                tags = listOf("Critical Thinking", "Logic", "Decision Making", "Self-Help"),
            ...
            Book(
                ...
                tags = listOf("Behavioral Finance", "Compounding", "Finance Freedom", "Personal Finance"),
            ...
            Book(
                ...
                tags = listOf("Education", "Self-Discovery", "Power of Education", "Liberation"),
            ...
            Book(
                ...
                tags = listOf("Mental Health", "Suicidal Ideation", "Bullying", "Loneliness"),
            ...
            Book(
                ...
                tags = listOf("Stoikisme", "Filosofi Hidup", "Kebahagiaan", "Pengembangan Diri"),
